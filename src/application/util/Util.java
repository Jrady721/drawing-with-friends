...
public class Util {
    ...
    private static void centerStage(Stage stage) {
        Stage parent = Main.primaryStage;
    ...
    public static void Move(String page, String title) throws Exception {
        if (title.equals("게스트") || title.equals("그림 그리기")) {
            ...
            Parent root = FXMLLoader.load(Main.class.getResource("view/" + page + ".fxml"));
